...
@Component
class KtLmsMmsProvider(
    webClient: WebClient,
    circuitBreaker: CircuitBreaker,
    @param:Value("\${provider.kt.lmsmms.endpoint:/api/kt/lmsmms}")
    private val endpointPath: String = "/api/kt/lmsmms"
) : AbstractHttpProvider<KtLmsMmsProvider.Response>(webClient, circuitBreaker, Response::class.java) {
    ...
    override val logPrefix: String = "KT-LMS/MMS"
