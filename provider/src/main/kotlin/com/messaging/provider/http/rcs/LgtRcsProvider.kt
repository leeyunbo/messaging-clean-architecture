...
@Component
class LgtRcsProvider(
    webClient: WebClient,
    circuitBreaker: CircuitBreaker,
    @param:Value("\${provider.lgt.rcs.endpoint:/api/lgt/rcs}")
    private val endpointPath: String = "/api/lgt/rcs"
) : AbstractHttpProvider<LgtRcsProvider.Response>(webClient, circuitBreaker, Response::class.java) {

    override fun supportedTypes(): Set<MessageType> = setOf(MessageType.RCS)

    override fun supportedCarrier(): Carrier = Carrier.LGT

    override val logPrefix: String = "LGT-RCS"
