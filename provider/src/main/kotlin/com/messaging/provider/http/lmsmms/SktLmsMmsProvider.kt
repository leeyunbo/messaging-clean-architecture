...
@Component
class SktLmsMmsProvider(
    webClient: WebClient,
    circuitBreaker: CircuitBreaker,
    @param:Value("\${provider.skt.lmsmms.endpoint:/api/skt/lmsmms}")
    private val endpointPath: String = "/api/skt/lmsmms"
) : AbstractHttpProvider<SktLmsMmsProvider.Response>(webClient, circuitBreaker, Response::class.java) {
    ...
    override val logPrefix: String = "SKT-LMS/MMS"
