...
class KtRcsProvider(
    ...
    @param:Value("\${provider.kt.rcs.endpoint:/api/kt/rcs}")
    private val endpointPath: String = "/api/kt/rcs"
) : AbstractHttpProvider<KtRcsProvider.Response>(webClient, circuitBreaker, Response::class.java) {

    override fun supportedTypes(): Set<MessageType> = setOf(MessageType.RCS)

    override fun supportedCarrier(): Carrier = Carrier.KT

    override val logPrefix: String = "KT-RCS"
